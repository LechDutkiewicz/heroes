...
export const ROZSTAWIENIE: Array<{
  ...
  { x: 11, y: 17, rodzaj: 'artefakt', strefa: 'dom' },
  { x: 11, y: 3, rodzaj: 'potwor', strefa: 'dom', sila: 'slaby' },
  ...
  { x: 28, y: 24, rodzaj: 'surowiec', strefa: 'pogranicze', surowiec: 'odlamek' },
  ...
  { x: 31, y: 26, rodzaj: 'surowiec', strefa: 'pogranicze', surowiec: 'kamien' },
  { x: 29, y: 22, rodzaj: 'kopalnia', strefa: 'pogranicze', surowiec: 'odlamek' },
  { x: 32, y: 22, rodzaj: 'skrzynia', strefa: 'pogranicze' },
  { x: 32, y: 27, rodzaj: 'skrzynia', strefa: 'pogranicze' },
  { x: 30, y: 26, rodzaj: 'artefakt', strefa: 'pogranicze' },
  { x: 29, y: 26, rodzaj: 'potwor', strefa: 'pogranicze', sila: 'sredni' },
  { x: 32, y: 29, rodzaj: 'potwor', strefa: 'pogranicze', sila: 'slaby' },
  { x: 31, y: 22, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'wieza-obserwacyjna' },
  { x: 34, y: 3, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'gniazdo' },
  { x: 24, y: 4, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'chatka' },
  { x: 31, y: 28, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'woz' },
  { x: 20, y: 15, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'arena' },
  { x: 30, y: 24, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'ognisko' },
  ...
  { x: 24, y: 14, rodzaj: 'kopalnia', strefa: 'wroga', surowiec: 'pokeball' },
  { x: 23, y: 15, rodzaj: 'potwor', strefa: 'wroga', sila: 'sredni' },
  { x: 33, y: 16, rodzaj: 'skrzynia', strefa: 'wroga' },
  { x: 31, y: 7, rodzaj: 'skrzynia', strefa: 'wroga' },
  { x: 32, y: 17, rodzaj: 'potwor', strefa: 'wroga', sila: 'sredni' },
  { x: 30, y: 8, rodzaj: 'potwor', strefa: 'wroga', sila: 'sredni' },
  { x: 23, y: 11, rodzaj: 'surowiec', strefa: 'wroga', surowiec: 'kamien' },
  { x: 25, y: 9, rodzaj: 'surowiec', strefa: 'wroga', surowiec: 'kamien' },
  { x: 23, y: 10, rodzaj: 'budynek', strefa: 'wroga', budynek: 'kamienna-wieza' },
];
