...
export const TEREN = [
  ...
  'TTT.......=....~~jjjjjj###TTTT=..TTT',
  'TTT......=......~~jjjjj###TTT==.TTTT',
  'TTTTTT..........~~jjjjj###TTTTT#.TTT',
  'TTTTTT...........~~jjjj###TTTT####TT',
  'TTTTTTT..........~~jjjj###TTTTT###TT',
  'TTTTTTTTT........~~~jjj###TTTT###TTT',
];
...
export const ROZSTAWIENIE: Array<{
  ...
  { x: 11, y: 24, rodzaj: 'surowiec', strefa: 'dom', surowiec: 'odlamek' },
  ...
  { x: 5, y: 21, rodzaj: 'surowiec', strefa: 'dom', surowiec: 'pokeball' },
  ...
  { x: 21, y: 33, rodzaj: 'budynek', strefa: 'pogranicze', budynek: 'ognisko' },
  { x: 21, y: 31, rodzaj: 'surowiec', strefa: 'pogranicze', surowiec: 'odlamek' },
  { x: 19, y: 34, rodzaj: 'surowiec', strefa: 'pogranicze', surowiec: 'kamien' },
