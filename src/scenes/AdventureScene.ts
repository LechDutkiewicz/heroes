...
export class AdventureScene extends Phaser.Scene {
  ...
  private rozliczBitwe() {
    ...
    if (wynik.wygrana) {
      ...
      // i warunek `!zajety`.
      // (Rzeczy LEŻĄCE — surowiec, artefakt, skrzynia — nie trafiają tu nigdy,
      // bo podnosi się je z sąsiedniego pola i bohater na nich nie staje.)
      const podNogami = obiektNa(this.stan, this.stan.bohater.x, this.stan.bohater.y);
      if (podNogami && podNogami !== o && !podNogami.zebrany && !podNogami.nasz) {
